...
export default function Education(): React.ReactElement {
  return (
    <section className="scroll-section max-w-6xl mx-auto py-12 sm:py-9 lg:py-12 px-4 sm:px-6 lg:px-8" id="education">
...
function EducationCard({ item }: EducationCardProps): React.ReactElement {
  return (
    <div className={`border-b border-white/30 pb-3 sm:pb-4 lg:w-[45%] xl:w-1/3 md:w-3/4 w-full ${
